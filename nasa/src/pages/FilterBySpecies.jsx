...
import { FilterbySpecies } from "../services/filterBySpecies";
...
export function FilterSpecies() {
    ...
    useEffect(() => {
        const onSubmitHandler = async () => {
          try {
            console.log("click");
            const data = await FilterbySpecies( gender, pagination);
